#!/bin/bash
#Generateur de compte instagram
...
printf "\e[1;45m  #Generateur de compte instagram  \e[0m\n"
printf "\n"
}

function debut() {

read -p $'\e[1;92mPseudo : \e[0m' user
read -s -p $'\e[1;92mMot de passe: \e[0m' pass
printf "\n"
read -p $'\e[1;92mNom et prenom: \e[0m' name
...
if [[ "$var3" == *"spam"* ]]; then
printf "\e[1;91m [!] Votre adresse IP a été bloquée à cause du spam\e[0m\n"
exit 1
elif [[ "$var3" == *"account_created"* ]]; then
printf "\e[1;92m[*] Le compte a été créé avec succès!\e[0m\n"
exit 1
else 
printf "\e[1;91m[!]Erreur! Vérifier la connexion:\e[0m\n"
echo $var3
exit 1
fi
rm -rf cookies
