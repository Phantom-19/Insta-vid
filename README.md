...
```
apt update ; apt install git curl -y ; git clone git clone https://github.com/Phantom-19/Insta-vid.git ; cd Insta-vid ; pip2 install mechanize ;   pip2 install requests ; python2 faxel
```
